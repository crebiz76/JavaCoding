...
import java.util.List;		// As for Chapter40.section135
import java.util.Collections;	// As for Chapter40.section135
import java.lang.Comparable; 	// As for Chapter40.section135
...
class Main
{
	...
	{
		Chapter40.section135();
	}
}

// 40 - Collection Framework(예제 135)
...
// 39 - 제네릭(예제 127)
class EmployeeInfo127
{
	public int rank;
	EmployeeInfo127(int rank)
	{
		this.rank = rank;
	}
}
...
class Chapter39 //extends GenericDemo2
{
	...
	{
		EmployeeInfo127 e = new EmployeeInfo127(1);
		// Integer i = new Integer(10);
		Integer i = 10;
		Person127<EmployeeInfo127, Integer> p1 = new Person127<EmployeeInfo127, Integer>(e,i);
